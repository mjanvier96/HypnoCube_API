...
void ShowUsage(const string & programName)
	{
	cerr << "Usage: " << programName << " COMx [cube|square]\n";
	cerr << " Where COMx is the COM port with the gadget attached,\n";
	cerr << " and cube or square is the device attached.\n";
	cerr << "Example: " << programName << " COM4 cube\n";
	cerr << "Example: " << programName << " COM3 square\n";
	} // ShowUsage
